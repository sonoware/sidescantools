...
class SidescanToolsMain(QWidget):
    ...
    def initGUI(self):
        ...
        self.title_img = QPixmap("./res/sidescantools_logo_eck.png")
...
class ProcessingWidget(QVBoxLayout):
    ...
    def start_intern_processing_manager(self, files: list):
        ...
        pre_proc_mng.proc_files(
            ...
            active_downsampling=self.active_bottom_detection_downsampling_checkbox.isChecked(),
...
class ViewAndExportWidget(QVBoxLayout):
    ...
    def show_proc_file_in_napari(self):
        ...
        pre_proc_mng.proc_files(
            ...
            active_downsampling=self.main_ui.processing_widget.active_bottom_detection_downsampling_checkbox.isChecked(),
